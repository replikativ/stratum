...
public final class ColumnOps {
    ...
    // Microsecond-precision date/time kernels live in ColumnOpsTemporal.java
    // (extracted to keep this class under the JIT compilation budget — see
    // MEMORY.md "JIT Optimization Lessons" for the pattern).
